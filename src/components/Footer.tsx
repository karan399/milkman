      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-orange-400 mb-4">Mithai Bhandar</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#categories" className="text-gray-300 hover:text-orange-400 transition-colors">Our Sweets</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">info@mithaibhandar.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 Mithai Bhandar. All rights reserved. Made with ❤️ for sweet lovers.
          </p>
        </div>
      </div>
    </footer>
