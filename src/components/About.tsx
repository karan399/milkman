        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Founded in 1998, Mithai Bhandar has been serving authentic Indian sweets 
          ...
          <div className="relative">
            <img
              src="https://images.pexels.com/photos/6212166/pexels-photo-6212166.jpeg?auto=compress&cs=tinysrgb&w=800"
